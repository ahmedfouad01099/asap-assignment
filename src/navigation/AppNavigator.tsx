...
const TabNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen name="ItemMenu" component={ItemMenuOverviewScreen} options={{ tabBarLabel: 'Items' }} />
      <Tab.Screen name="SaleInvoiceList" component={SaleInvoiceListScreen} options={{ tabBarLabel: 'Sales' }} />
      <Tab.Screen name="Customers" component={CustomerManagementListScreen} options={{ tabBarLabel: 'CRM' }} />
    </Tab.Navigator>
  );
};
